...
output=$(kubectl get po --all-namespaces | grep "ubiquity-db*"  | awk '{ print $4 }' | sed -n '1p')
...
output=$(kubectl get po --all-namespaces | grep "ubiquity-k8s-provisioner*"  | awk '{ print $4 }' | sed -n '1p')
...
output=$(kubectl get po --all-namespaces | grep "ubiquity-k8s-flex*"  | awk '{ print $4 }' | sed -n '1p')
